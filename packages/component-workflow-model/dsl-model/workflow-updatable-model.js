...
class WorkflowUpdatableModel extends WorkflowModel {
    ...
    static async updateMutationEndpoint(ctxt, {input}, context, info) {
        ...
        if(this.aclSet) {
            ...
            this._debugAclMatching(user, aclTargets, isOwner, AclActions.Access, accessMatch, `mutation-update`);
            ...
            this._debugAclMatching(user, aclTargets, isOwner, AclActions.Write, aclWriteMatch, `mutation-update`);
